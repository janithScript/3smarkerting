                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card border-0 text-center h-100">
                            <div class="card-body">
                                ...
                                <h5>WhatsApp</h5>
                                <a href="https://wa.me/<?php echo e(str_replace(['+', ' ', '-'], '', $companySetting->whatsapp_number)); ?>" class="text-decoration-none" target="_blank">
                                    Send Message
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\3smarkerting\my_project_name\resources\views/pages/about.blade.php ENDPATH**/ ?>